        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <p className="text-lg sm:text-xl text-slate-600 mb-8 max-w-xl mx-auto lg:mx-0">
              ...
              返信率を<span className="font-bold text-indigo-600">3倍</span>に向上させます。
            </p>

            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <a
                href="#contact"
                className="bg-indigo-600 text-white px-8 py-4 rounded-full font-medium text-lg hover:bg-indigo-700 transition-all hover:scale-105 shadow-lg shadow-indigo-200"
              >
                無料で試してみる
              </a>
              <a
                href="#how-it-works"
                className="border-2 border-slate-200 text-slate-700 px-8 py-4 rounded-full font-medium text-lg hover:border-indigo-300 hover:text-indigo-600 transition-colors"
              >
                詳しく見る
              </a>
            </div>
          ...
          <div className="relative">
            <div className="relative bg-gradient-to-br from-indigo-100 to-cyan-100 rounded-3xl p-8 shadow-2xl">
              {/* Mock Video Player */}
              ...
              <div className="absolute -bottom-4 -left-4 bg-white rounded-xl shadow-lg p-3 animate-float" style={{ animationDelay: "1s" }}>
                <div className="flex items-center gap-2">
                  <span className="text-2xl">📧</span>
                  <span className="text-sm font-medium text-green-600">返信率 +200%</span>
                </div>
              </div>
            </div>
          </div>
